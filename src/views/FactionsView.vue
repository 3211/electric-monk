          ...
          <div class="glass-panel glass-panel-soft glass-gloss mb-8 p-5 sm:p-6">
            ...
            >
              <div
                ...
                :key="player.id"
                class="flex items-center gap-3 py-2.5 px-3 rounded-sm transition-colors duration-200 hover:bg-white/5"
            ...
            >
              ...
              >
                <div
                  ...
                  :key="player.id"
                  class="flex items-center gap-2.5 py-2.5 px-3 rounded-sm transition-colors duration-200 hover:bg-white/5"
                  :class="{ 'bg-theme-accent/10 ring-1 ring-theme-accent/20': isCurrentUser(player.id) }"
                >
