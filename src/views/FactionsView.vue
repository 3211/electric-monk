      ...
      <div class="app-frame py-5">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div class="relative min-w-0">
            ...
            <h1 class="faction-page-title ritual-heading relative text-4xl font-bold text-theme-accent sm:text-5xl">鋤・・Sects</h1>
    ...
    <main class="factions-war-main app-frame py-8 lg:py-10">
      ...
      <div v-if="activeTab === 'overview'">
        <div v-if="loading" class="glass-panel glass-panel-soft faction-state-card p-12 text-center">
          <div class="text-4xl mb-4" style="animation: ritual-breathe 3s ease-in-out infinite">鋤・・/div>
              ...
              <div class="faction-diamond-wrapper">
                <div class="faction-diamond-shell">
                  ...
                  <div class="faction-core-seal" aria-hidden="true">
                    <span class="faction-core-seal-icon">{{ FACTION_ICONS[focusFactionKey] || '鋤・・ }}</span>
                ...
                <div class="faction-section-card">
                  ...
                  <div v-else class="space-y-2">
                    ...
                    >
                      ...
                      <span class="chip text-xs">{{ member.karma }} 笞｡</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="faction-relationship-stack">
                    <div class="faction-relationship-card faction-relationship-card--ally">
                      <span class="chip faction-relation-badge faction-relation-badge--ally text-xs py-2 px-3">
                        泙 Ally: {{ FACTION_NAMES[factionData[selectedFaction].ally] }}
                      </span>
                      <span v-if="factionData[selectedFaction].rationale_ally" class="text-xs text-theme-text-muted">窶・{{ factionData[selectedFaction].rationale_ally }}</span>
                    </div>
                    <div class="faction-relationship-card faction-relationship-card--enemy">
                      <span class="chip faction-relation-badge faction-relation-badge--enemy text-xs py-2 px-3">
                        閥 Enemy: {{ FACTION_NAMES[factionData[selectedFaction].enemy] }}
                      </span>
                      <span v-if="factionData[selectedFaction].rationale_enemy" class="text-xs text-theme-text-muted">窶・{{ factionData[selectedFaction].rationale_enemy }}</span>
                    </div>
                    <div class="faction-relationship-card faction-relationship-card--neutral">
                      <span class="chip faction-relation-badge faction-relation-badge--neutral text-xs py-2 px-3">
                        泯 Neutral: {{ FACTION_NAMES[factionData[selectedFaction].neutral] }}
                      </span>
                      <span v-if="factionData[selectedFaction].rationale_neutral" class="text-xs text-theme-text-muted">窶・{{ factionData[selectedFaction].rationale_neutral }}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="activeTab === 'rankings'">
        ...
        <template v-else>
          ...
          <div class="glass-panel glass-panel-soft glass-gloss mb-8 p-5 sm:p-6">
            <h2 class="ritual-heading text-xl font-bold text-theme-accent mb-4 text-center">醇 Top 5 Overall</h2>
            <div
              ref="globalScrollRef"
            ...
            >
              ...
              >
                ...
                <span v-if="player.divine_shield_until && new Date(player.divine_shield_until) > new Date()" class="text-yellow-500 text-xs flex-shrink-0" title="Divine Shield active">孱</span>
          ...
          >
            ...
            <div v-else-if="leaderboard.userIsTop5">
              <p class="text-lg font-bold text-theme-accent ritual-heading mb-5">
                醇 Your Position: <span class="text-2xl">Top 5</span>
              </p>
