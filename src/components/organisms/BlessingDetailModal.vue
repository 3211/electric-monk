        ...
        <div class="relative">
          ...
          <div v-if="blessings && blessings.length > 0" class="space-y-3">
            <div
              ...
              class="flex items-center gap-3 rounded-xl border border-theme-border/40 bg-white/30 p-3"
            >
              <span class="flex h-10 w-10 flex-none items-center justify-center rounded-xl border border-theme-accent/15 bg-white/50 text-xl shadow-[0_8px_16px_rgba(213,154,23,0.08)]">{{ b.emoji }}</span>
