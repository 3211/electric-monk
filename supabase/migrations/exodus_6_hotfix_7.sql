-- ============================================================
-- Exodus 6 Hotfix 7: Sect-Only Visibility for Shouts
-- ============================================================
-- Adds: is_sect_only column to shouts table
-- Updates: submit_shout RPC to accept p_is_sect_only parameter
-- Updates: get_shouts RPC to filter global feed by sect-only visibility
-- Updates: get_shout_replies RPC to include is_sect_only in shout data
-- ============================================================
...
ALTER TABLE shouts ADD COLUMN IF NOT EXISTS is_sect_only BOOLEAN NOT NULL DEFAULT false;

-- Index for efficient filtering on global feed
CREATE INDEX IF NOT EXISTS idx_shouts_is_sect_only ON shouts(is_sect_only) WHERE is_sect_only = true;

-- ============================================================
-- RPC: submit_shout (updated with p_is_sect_only)
-- ============================================================
...
-- ============================================================
-- RPC: get_shouts (updated with sect-only visibility filtering)
-- ============================================================
-- Global feed: only shows shouts where is_sect_only=false OR
--              the shout's sect_type matches the viewer's sect_type.
-- Sect feed: shows all shouts for the viewer's sect (is_sect_only
--            doesn't restrict here since you're already in that sect).
-- Synod feed: unchanged (synod-private already).
...
-- ============================================================
-- RPC: get_shout_replies (updated to include is_sect_only)
-- ============================================================
...
-- ============================================================
-- GRANTS (re-grant for updated function signatures)
-- ============================================================
