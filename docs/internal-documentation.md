...
Electric Monk (aka Holy War Online) is a theological PBBG (Persistent Browser-Based Game) built with Vue 3 + Supabase. Players choose a faction, build an economy, wage asymmetric war, research tech, join synods, steal relics, and pray to generate karma.
